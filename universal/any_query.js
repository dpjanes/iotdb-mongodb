...
/**
 */
const any_query = (_descriptor, _index) => {
    ...
    f.method = `${_descriptor.name}.any_query`
    f.description = `Do any ${_descriptor.one} records match query`
    f.requires = {
